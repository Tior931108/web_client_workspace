...
const test1 = () => {
    ...
    // console.log(obj.father.job()); // 13_object.js:55 Uncaught TypeError: Cannot read properties of undefined (reading 'job')
...
const test2 = () => {
    const user = {
        ...
        run : function(){
            // this용법2. 객체메소드(일반함수: 화살표 함수가 아닌것) 안 this는 현재객체를 가리킨다.
        ...
        work: () => {
            ...
            console.log(`${this.username}이/가 일한다.`); // undefined
        }
    }; 
...
const test3 = () => {
    ...
    console.log(calculator.multiplay(10, 20));
