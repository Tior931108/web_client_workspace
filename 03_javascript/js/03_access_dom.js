...
// html문서(텍스트)를 계층구조를 반영하여 javascript객체로 변환
// document
...
function getById() {
    ...
    const notExist = document.getElementById("asdafqwfasfaef");
...
/**
 * getElementByName(name: string) : object[]
 */
function getByName() {
...
function checkAll() {
    ...
    // id가 유일하기 떄문에 해당 아이디를 변수처럼 바로 사용가능
...
function inputUser() {
    const scan = document.getElementById('name');
...
/**
 * css선택자를 이용해서 여러개의 DOM 요소를 배열로 반환
 */
